...
public class CutScenePauseMenu extends Screen {
    ...
    protected void init() {
        ...
        //Back to Game
        this.addRenderableWidget(new Button(this.width / 2 - 102, this.height / 4 + 24 + 16, 204, 20, new TranslatableComponent("menu.returnToGame"), (press) -> {
        ...
        if (this.parent.allowSkip) {
            this.addRenderableWidget(new Button(this.width / 2 - 102, this.height / 4 + 24 + 16 + 25, 204, 20, new TextComponent(Locals.localize("cinematica.cutscene.skip")), (press) -> {
                this.parent.isPaused = false;
                this.parent.removed();
        ...
        Component quitBtnLabel = this.minecraft.isLocalServer() ? new TranslatableComponent("menu.returnToMenu") : new TranslatableComponent("menu.disconnect");
