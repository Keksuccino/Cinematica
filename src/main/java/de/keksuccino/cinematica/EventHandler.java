...
public class EventHandler {
    ...
    public void onDrawScreenPost(ScreenEvent.DrawScreenEvent.Post e) {
        ...
        if (((e.getScreen() instanceof PauseScreen) || (e.getScreen() instanceof CutScenePauseMenu)) && Cinematica.config.getOrDefault("show_controls_in_pause_screen", true) && !PopupHandler.isPopupActive()) {
            ...
            this.cinematicaButton.render(e.getPoseStack(), e.getMouseX(), e.getMouseY(), e.getPartialTicks());
        ...
        try {
            if (Cinematica.config.getOrDefault("print_died_entities", false)) {
                if ((Minecraft.getInstance().level != null) && (Minecraft.getInstance().player != null)) {
                    Minecraft.getInstance().player.sendMessage(new TextComponent("§e-----------------------"), UUID.randomUUID());
                    Minecraft.getInstance().player.sendMessage(new TextComponent("§e[CINEMATICA] DEBUG: §lENTITY DIED:"), UUID.randomUUID());
                    Minecraft.getInstance().player.sendMessage(new TextComponent("§e[CINEMATICA] DEBUG: ID/TYPE: " + e.getEntity().getType().getRegistryName().toString()), UUID.randomUUID());
                    Minecraft.getInstance().player.sendMessage(new TextComponent("§e[CINEMATICA] DEBUG: NAME: " + StringUtils.convertFormatCodes(e.getEntity().getName().getString(), "§", "&")), UUID.randomUUID());
                    Minecraft.getInstance().player.sendMessage(new TextComponent("§e-----------------------"), UUID.randomUUID());
                }
            }
        } catch (Exception ex) {
    ...
    public void onItemAddedToInventory(AddItemToPlayerInventoryEvent e) {
        try {
            if (Cinematica.config.getOrDefault("print_added_items", false)) {
                if ((Minecraft.getInstance().level != null) && (Minecraft.getInstance().player != null)) {
                    Minecraft.getInstance().player.sendMessage(new TextComponent("§e-----------------------"), UUID.randomUUID());
                    Minecraft.getInstance().player.sendMessage(new TextComponent("§e[CINEMATICA] DEBUG: §lITEM ADDED TO INVENTORY:"), UUID.randomUUID());
                    Minecraft.getInstance().player.sendMessage(new TextComponent("§e[CINEMATICA] DEBUG: ITEM TYPE: " + e.getStack().getItem().getRegistryName().toString()), UUID.randomUUID());
                    Minecraft.getInstance().player.sendMessage(new TextComponent("§e[CINEMATICA] DEBUG: ITEM NAME: " + StringUtils.convertFormatCodes(e.getStack().getHoverName().getString(), "§", "&")), UUID.randomUUID());
                    Minecraft.getInstance().player.sendMessage(new TextComponent("§e[CINEMATICA] DEBUG: ITEM COUNT: " + e.getStack().getCount()), UUID.randomUUID());
                    String lore = FormattingUtils.deserializeItemLoreToString(e.getStack());
                    if (lore != null) {
                        Minecraft.getInstance().player.sendMessage(new TextComponent("§e[CINEMATICA] DEBUG: ITEM LORE: " + StringUtils.convertFormatCodes(lore, "§", "&")), UUID.randomUUID());
                    }
                    Minecraft.getInstance().player.sendMessage(new TextComponent("§e-----------------------"), UUID.randomUUID());
                }
            }
