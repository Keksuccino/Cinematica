...
public class KillEntityConditionScreen extends ScrollableScreen {
    ...
    protected void init() {
        ...
        if (KillEntityConditionFactory.lastKilledEntity != null) {
            lastKilledType = Registry.ENTITY_TYPE.getKey(KillEntityConditionFactory.lastKilledEntity.getType()).getNamespace() + ":" + Registry.ENTITY_TYPE.getKey(KillEntityConditionFactory.lastKilledEntity.getType()).getPath();
        }
