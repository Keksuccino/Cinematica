...
public class EntityIsInRangeCondition extends Condition {

    public EntityIsInRangeCondition(@Nullable String identifier, ConditionFactory parent, PropertiesSection conditionMeta) {
            ...
            if ((Minecraft.getInstance().level != null) && (Minecraft.getInstance().player != null)) {
                ...
                if ((conRange != null) && MathUtils.isInteger(conRange)) {
                    ...
                    for (Entity e : entitiesInRange) {
                        if (e != null) {
                            typesInRange.add(e.getType().getRegistryName().toString());
