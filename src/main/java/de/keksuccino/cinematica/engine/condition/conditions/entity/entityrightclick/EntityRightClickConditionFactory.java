...
public class EntityRightClickConditionFactory extends ConditionFactory {
    ...
    public void conditionContextTick() {
        ...
        if ((this.rightClickTarget != null) && (Minecraft.getInstance().world != null) && (Minecraft.getInstance().player != null)) {
            ...
            sec.addEntry("entity_type", this.rightClickTarget.getType().getRegistryName().toString());
    ...
    public void onAddConditionButtonClick(AdvancedButton parentBtn, Screen parentScreen, Cinematic cinematicToAddTheConditionTo) {
        Minecraft.getInstance().displayGuiScreen(new EntityConditionScreen(parentScreen, null, (call) -> {
            if (call != null) {
    ...
    public void onEditConditionButtonClick(AdvancedButton parentBtn, Screen parentScreen, Condition conditionToEdit, Cinematic parentOfCondition) {
        Minecraft.getInstance().displayGuiScreen(new EntityConditionScreen(parentScreen, conditionToEdit.conditionMeta, (call) -> {
            if (call != null) {
