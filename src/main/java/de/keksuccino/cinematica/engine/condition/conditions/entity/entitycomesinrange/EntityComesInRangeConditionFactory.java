...
public class EntityComesInRangeConditionFactory extends ConditionFactory {

    public EntityComesInRangeConditionFactory() {
        super("cinematica_condition_entity_comes_in_range");
    }
    ...
    public Condition createConditionFromSerializedObject(Condition.SerializedCondition serialized) {
        return new EntityComesInRangeCondition(serialized.identifier, this, serialized.conditionMeta);
    }
    ...
    public void onAddConditionButtonClick(AdvancedButton parentBtn, Screen parentScreen, Cinematic cinematicToAddTheConditionTo) {
        Minecraft.getInstance().setScreen(new EntityRangeConditionScreen(parentScreen, null, (call) -> {
            if (call != null) {
                cinematicToAddTheConditionTo.addCondition(new EntityComesInRangeCondition(null, this, call));
            }
        }));
    }
    ...
    public String getDisplayName() {
        return Locals.localize("cinematica.condition.entity.comesinrange");
    }

    @Override
    public List<String> getDescription() {
        return Arrays.asList(StringUtils.splitLines(Locals.localize("cinematica.condition.entity.comesinrange.desc"), "%n%"));
    }
