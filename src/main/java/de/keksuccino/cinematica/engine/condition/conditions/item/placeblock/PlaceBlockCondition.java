...
public class PlaceBlockCondition extends Condition {

    public PlaceBlockCondition(@Nullable String identifier, ConditionFactory parent, PropertiesSection conditionMeta) {
