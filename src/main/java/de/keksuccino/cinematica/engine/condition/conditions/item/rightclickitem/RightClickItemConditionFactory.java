...
public class RightClickItemConditionFactory extends ConditionFactory {
    ...
    public void conditionContextTick() {
        if ((this.rightClickedItem != null) && (Minecraft.getInstance().player != null) && (Minecraft.getInstance().world != null)) {
            ...
            sec.addEntry("item_name", StringUtils.convertFormatCodes(this.rightClickedItem.getDisplayName().getString(), "§", "&"));
