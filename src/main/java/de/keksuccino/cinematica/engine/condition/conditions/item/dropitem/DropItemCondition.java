...
public class DropItemCondition extends Condition {

    public DropItemCondition(@Nullable String identifier, ConditionFactory parent, PropertiesSection conditionMeta) {
