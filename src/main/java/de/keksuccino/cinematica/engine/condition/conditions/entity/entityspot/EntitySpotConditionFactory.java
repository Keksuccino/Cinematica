...
public class EntitySpotConditionFactory extends ConditionFactory {

    public EntitySpotConditionFactory() {
        super("cinematica_condition_entity_spot");
    }
    ...
    public Condition createConditionFromSerializedObject(Condition.SerializedCondition serialized) {
        return new EntitySpotCondition(serialized.identifier, this, serialized.conditionMeta);
    }
    ...
    public String getDisplayName() {
        return Locals.localize("cinematica.condition.entity.spot");
    }

    @Override
    public List<String> getDescription() {
        return Arrays.asList(StringUtils.splitLines(Locals.localize("cinematica.condition.entity.spot.desc"), "%n%"));
    }
