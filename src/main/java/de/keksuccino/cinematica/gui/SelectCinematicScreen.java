...
public class SelectCinematicScreen extends Screen {
    ...
    public SelectCinematicScreen(Screen parent, Trigger trigger, Consumer<Cinematic> callback) {
    ...
    protected void updateEntries() {
        if (this.cinematicScrollList != null) {
            ...
            for (Cinematic c : this.trigger.getCinematics()) {
    ...
    public void render(MatrixStack matrix, int mouseX, int mouseY, float partialTicks) {
        ...
        //Draw title
        drawCenteredString(matrix, font, Locals.localize("cinematica.cinematic.choosecinematic"), this.width / 2, 20, -1);
