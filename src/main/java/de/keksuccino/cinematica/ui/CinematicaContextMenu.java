...
public class CinematicaContextMenu extends ContextMenu {
	...
	public void openMenuAt(int x, int y, int screenWidth, int screenHeight) {
		...
		if (this.parent != null) {
			if (this.parent instanceof CinematicaContextMenu) {
				screenWidth = ((CinematicaContextMenu) this.parent).cachedScreenWidth;
				screenHeight = ((CinematicaContextMenu) this.parent).cachedScreenHeight;
			}
		}
