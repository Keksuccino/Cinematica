...
public class MenuBar extends UIBase {
	...
	public static final ResourceLocation CINEMATICA_LOGO_TEXTURE = new ResourceLocation("keksuccino", "fm_pixel_logo.png");
	...
	public MenuBar() {
		...
		//Add default Cinematica button
		AdvancedButton fmBtn = new AdvancedImageButton(0, 0, 0, 0, CINEMATICA_LOGO_TEXTURE, true, (press) -> {
